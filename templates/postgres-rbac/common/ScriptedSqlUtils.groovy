...
/**
 * Generic helper methods used by multiple scripts:
 * - filter -> WHERE translation integration
 * - paging options
 * - insert/update/delete SQL generation using named parameters
 * - simple type conversions used by scripts
 *
 * This is copied from the example scripts to make this template self-contained.
 */
class ScriptedSqlUtils {
    ...
    static Long numberToLong(Number n) {
        return n?.longValue()
    }
